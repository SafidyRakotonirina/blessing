...
CREATE DATABASE IF NOT EXISTS blessing_school 
...
INSERT IGNORE INTO jours (nom, ordre) VALUES
('Lundi',    1), ('Mardi',   2), ('Mercredi', 3), ('Jeudi',   4),
('Vendredi', 5), ('Samedi',  6), ('Dimanche', 7);


INSERT IGNORE INTO horaires (heure_debut, heure_fin, libelle) VALUES
...
INSERT IGNORE INTO niveaux (code, nom, description, frais_inscription, frais_ecolage, prix_livre, duree_mois) VALUES
('A1','Débutant A1','Niveau débutant selon le CECRL',50000,200000,15000,2),
('A2','Élémentaire A2','Niveau élémentaire selon le CECRL',50000,220000,17500,2),
('B1','Intermédiaire B1','Niveau intermédiaire selon le CECRL',50000,250000,20000,3),
('B2','Intermédiaire avancé B2','Niveau intermédiaire avancé selon le CECRL',50000,280000,22500,3);


INSERT IGNORE INTO ecoles (nom, adresse, telephone, email) VALUES
('Centre de Formation Principal', '123 Rue de l\'Éducation, Antananarivo', '+261 20 00 000 00', 'contact@centre-formation.mg');


INSERT IGNORE INTO salles (nom, ecole_id, capacite, equipements) VALUES
...
INSERT IGNORE INTO utilisateurs (nom, prenom, email, telephone, password, role) VALUES
('Admin', '', 'admin@blessing.mg', '+261 32 12 345 67',
 '$2b$10$G3WhXaY/bcYXj66CIYGqautSe9WkgcKIkHVgFYWNiZbkQCd8fLW2G', 'admin');


-- Secrétaire par défaut (Secret123!) → CHANGEZ CE HASH EN PRODUCTION !
INSERT IGNORE INTO utilisateurs (nom, prenom, email, telephone, password, role) VALUES
('Rakoto', 'Marie', 'secretaire@example.com', '+261 34 00 000 01',
 '$2b$10$G3WhXaY/bcYXj66CIYGqautSe9WkgcKIkHVgFYWNiZbkQCd8fLW2G', 'secretaire');